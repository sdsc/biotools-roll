...
# check fai seqs
cmp -s ROLLINSTALL/testdata/$SEQ $DIR/fai/Sequences
if [ $? -ne 0 ]; then
...
# check fqi seqs
cmp -s ROLLINSTALL/testdata/$SEQ $DIR/fqi/Sequences
if [ $? -ne 0 ]; then
...
# check fai roadmap
cmp -s ROLLINSTALL/testdata/$ROADMAP $DIR/fai/Roadmaps
if [ $? -ne 0 ]; then
...
# check fqi roadmap
cmp -s ROLLINSTALL/testdata/$ROADMAP $DIR/fqi/Roadmaps
if [ $? -ne 0 ]; then
